...
?>
<!-- Bootstrap to create a form that will collect data from the user to create a new record in the database -->
<h1>Add Item</h1>
	<form action="create.php" method="post" >
	  <!-- input fields for each piece of data you want to collect -->
...
<!-- PHP to handle the form submission, checking if the form has been submitted and processing the data entered by the user -->
<?php
...
//add the script that will include the footer of the page
